"""
S&P 500 커스텀 RSI 기반 계절별 스타일 로테이션 전략 백테스팅 프로그램

사용자가 직접 계절별 스타일을 설정하여 맞춤형 로테이션 전략을 구성하고,
기존 전략들과 성과를 비교 분석할 수 있습니다.
...
def print_enhanced_results(results, custom_strategy_name):
    ...
    # 성과 요약 테이블
    print(f"{'전략명':<20} {'총수익률':<10} {'CAGR':<8} {'변동성':<8} {'MDD':<8} {'샤프비율':<8} {'구분':<8}")
    print("-" * 90)
